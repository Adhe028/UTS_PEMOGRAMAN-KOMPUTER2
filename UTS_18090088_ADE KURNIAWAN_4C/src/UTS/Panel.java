...
public class Panel extends javax.swing.JPanel {
    ...
    private void ModelTabel() {
        Object[] kolom = {"", "nama_perumahan", "alamat", "no_telp", "email", "pengembang", "tipe_perumahan","brosur"};
    ...
    private void TampilData(String key) {
        ...
        if (!key.isEmpty()) {
            where += "WHERE nama_perumahan LIKE '%" + key + "%' "
                    ...
                    + "OR tipe_rumah LIKE '%" + key + "%'"
                    + "OR brosur LIKE '%" + key + "%'";
        }
        String sql = "SELECT * FROM rumah " + where;
        Connection con;
        Statement st;
        ResultSet rs;
        int baris = 0;
        try {
            ...
            while (rs.next()) {
                ...
                Object brosur = rs.getString(7);
                Object alamat = rs.getString(8);
    ...
    private void pilihData(String n) {
        ...
        String sql = "SELECT * FROM rumah WHERE id_rumah='" + n + "'";
        Connection con;
        Statement st;
        ResultSet rs;
        try {
            ...
            while (rs.next()) {
                ...
                String pengembang = rs.getString(5);
                Object tipe_perumahan = rs.getString(6);
                String brosur = rs.getString(7);
    ...
    private void simpanData() {
        ...
        if (nama_perumahan.isEmpty() || alamat.isEmpty() || no_telp.isEmpty() || email.isEmpty() || pengembang.isEmpty() || tipe_perumahan == 0) {
            ...
            String sql
                    = "INSERT INTO rumah (nama_perumahan, alamat,no_tlp,"
                    + "email, pengembang, tipe_rumah, brosur) "
    ...
    private void ubahData() {
        ...
        if (nama_perumahan.isEmpty() || alamat.isEmpty() || no_telp.isEmpty() || email.isEmpty() || pengembang.isEmpty() || tipe_perumahan == 0) {
            ...
            String tipe_perumahan_isi = cmbTipe.getSelectedItem().toString();
            String sql = "UPDATE rumah "
                    + "SET nama_perumahan=\"" + nama_perumahan + "\","
                    + "alamat=\"" + alamat + "\","
                    + "no_tlp=\"" + no_telp + "\","
                    + "email=\"" + email + "\","
                    + "pengembang=\"" + pengembang + "\","
                    + "tipe_rumah=\"" + tipe_perumahan_isi +  "\" WHERE id_rumah=\"" + idBaris + "\"";
            Connection con;
            Statement st;
            try {
                con = Koneksi.MySQL();
    ...
    private void hapusData(int baris) {
        ...
        try {
            con = Koneksi.MySQL();
            st = con.createStatement();
            st.executeUpdate("DELETE FROM rumah WHERE id_rumah=" + baris);
            st.close();
            con.close();
            RefreshView();
    ...
    private void initComponents() {
        ...
        panelKiri.setBackground(new java.awt.Color(102, 51, 0));
        ...
        m.setFont(new java.awt.Font("Yu Gothic", 3, 12)); // NOI18N
        m.setText("Pilih File");
